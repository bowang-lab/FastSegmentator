...
<div class="wrap">
  ...
  <section>
    ...
    <div class="grid2">
      ...
      <div class="chartbox"><h3 style="margin:.2em 0 0;font-size:15px;color:#33414f">Single-case runtime composition</h3>
        ...
        <div class="pies">
          <div><canvas id="rtChart0" height="200"></canvas><div class="cap">%%RT_CAP0%%</div></div>
          <div><canvas id="rtChart1" height="200"></canvas><div class="cap">%%RT_CAP1%%</div></div>
        </div></div>
    </div>
    %%FWD_TABLE%%
  ...
  <section>
    ...
    <div class="chartbox"><h3 style="margin:.2em 0 0;font-size:15px;color:#33414f">Before → after (DSC)</h3>
      <canvas id="fixChart" height="280"></canvas></div>
    %%FIX_TABLE%%
  </section>

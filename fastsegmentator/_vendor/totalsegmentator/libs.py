...
from fastsegmentator._vendor.totalsegmentator.map_to_binary import class_map, class_map_5_parts, commercial_models
from fastsegmentator._vendor.totalsegmentator.config import get_totalseg_dir, get_weights_dir, is_valid_license, has_valid_license, has_valid_license_offline, get_version
from fastsegmentator._vendor.totalsegmentator.nifti_ext_header import load_multilabel_nifti, add_label_map_to_nifti
...
def download_pretrained_weights(task_id):
    ...
    # Commercial models
        ...
        weights_path = config_dir / "Dataset509_coronary_arteries_cm_nativ_400subj_SKELETON"
    elif task_id == 920:

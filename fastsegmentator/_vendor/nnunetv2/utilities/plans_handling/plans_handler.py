...
from fastsegmentator._vendor.nnunetv2.preprocessing.resampling.utils import recursive_find_resampling_fn_by_name
from fastsegmentator._vendor import nnunetv2
from batchgenerators.utilities.file_and_folder_operations import load_json, join

from fastsegmentator._vendor.nnunetv2.imageio.reader_writer_registry import recursive_find_reader_writer_by_name
from fastsegmentator._vendor.nnunetv2.utilities.find_class_by_name import recursive_find_python_class
from fastsegmentator._vendor.nnunetv2.utilities.label_handling.label_handling import get_labelmanager_class_from_plans
...
if TYPE_CHECKING:
    from fastsegmentator._vendor.nnunetv2.utilities.label_handling.label_handling import LabelManager
    from fastsegmentator._vendor.nnunetv2.imageio.base_reader_writer import BaseReaderWriter
    from fastsegmentator._vendor.nnunetv2.preprocessing.preprocessors.default_preprocessor import DefaultPreprocessor
    from fastsegmentator._vendor.nnunetv2.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
...
class ConfigurationManager(object):
    ...
    def preprocessor_class(self) -> Type[DefaultPreprocessor]:
        preprocessor_class = recursive_find_python_class(join(nnunetv2.__path__[0], "preprocessing"),
                                                         ...
                                                         current_module="fastsegmentator._vendor.nnunetv2.preprocessing")
...
class PlansManager(object):
    ...
    def experiment_planner_class(self) -> Type[ExperimentPlanner]:
        ...
        experiment_planner = recursive_find_python_class(join(nnunetv2.__path__[0], "experiment_planning"),
                                                         planner_name,
                                                         current_module="fastsegmentator._vendor.nnunetv2.experiment_planning")
...
if __name__ == '__main__':
    from fastsegmentator._vendor.nnunetv2.paths import nnUNet_preprocessed
    from fastsegmentator._vendor.nnunetv2.utilities.dataset_name_id_conversion import maybe_convert_to_dataset_name

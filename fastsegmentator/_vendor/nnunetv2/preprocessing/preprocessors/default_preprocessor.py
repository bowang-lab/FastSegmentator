...
from fastsegmentator._vendor.nnunetv2.paths import nnUNet_preprocessed, nnUNet_raw
from fastsegmentator._vendor.nnunetv2.preprocessing.cropping.cropping import crop_to_nonzero
from fastsegmentator._vendor.nnunetv2.preprocessing.resampling.default_resampling import compute_new_shape
...
from fastsegmentator._vendor.nnunetv2.utilities.utils import get_filenames_of_train_images_and_targets
from fastsegmentator._vendor.nnunetv2.preprocessing.resampling.default_resampling import fast_resample_data_or_seg_to_shape
    ...
    def _normalize(self, data: np.ndarray, seg: np.ndarray, configuration_manager: ConfigurationManager,
        ...
        for c in range(data.shape[0]):
            ...
            normalizer_class = recursive_find_python_class(join(nnunetv2.__path__[0], "preprocessing", "normalization"),
                                                           scheme,
                                                           'fastsegmentator._vendor.nnunetv2.preprocessing.normalization')

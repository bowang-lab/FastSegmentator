...
from fastsegmentator._vendor.nnunetv2.configuration import default_num_processes
from fastsegmentator._vendor.nnunetv2.inference.data_iterators import PreprocessAdapterFromNpy, preprocessing_iterator_fromfiles, \
    preprocessing_iterator_fromnpy
from fastsegmentator._vendor.nnunetv2.inference.export_prediction import export_prediction_from_logits, \
    convert_predicted_logits_to_segmentation_with_correct_shape
from fastsegmentator._vendor.nnunetv2.inference.sliding_window_prediction import compute_gaussian, \
    compute_steps_for_sliding_window
from fastsegmentator._vendor.nnunetv2.utilities.file_path_utilities import get_output_folder, check_workers_alive_and_busy
...
from fastsegmentator._vendor.nnunetv2.utilities.json_export import recursive_fix_for_json_export
from fastsegmentator._vendor.nnunetv2.utilities.label_handling.label_handling import determine_num_input_channels
from fastsegmentator._vendor.nnunetv2.utilities.plans_handling.plans_handler import PlansManager, ConfigurationManager
from fastsegmentator._vendor.nnunetv2.utilities.utils import create_lists_from_splitted_dataset_folder
...
class nnUNetPredictor(object):
    ...
    def initialize_from_trained_model_folder(self, model_training_output_dir: str,
        ...
        trainer_class = recursive_find_python_class(join(nnunetv2.__path__[0], "training", "nnUNetTrainer"),
                                                    trainer_name, 'fastsegmentator._vendor.nnunetv2.training.nnUNetTrainer')
...
if __name__ == '__main__':
    ...
    from fastsegmentator._vendor.nnunetv2.paths import nnUNet_results, nnUNet_raw

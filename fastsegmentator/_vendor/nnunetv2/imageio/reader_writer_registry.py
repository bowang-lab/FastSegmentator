...
from fastsegmentator._vendor.nnunetv2.imageio.natural_image_reader_writer import NaturalImage2DIO
from fastsegmentator._vendor.nnunetv2.imageio.nibabel_reader_writer import NibabelIO, NibabelIOWithReorient
from fastsegmentator._vendor.nnunetv2.imageio.simpleitk_reader_writer import SimpleITKIO
from fastsegmentator._vendor.nnunetv2.imageio.tif_reader_writer import Tiff3DIO
...
def recursive_find_reader_writer_by_name(rw_class_name: str) -> Type[BaseReaderWriter]:
    ret = recursive_find_python_class(join(nnunetv2.__path__[0], "imageio"), rw_class_name, 'fastsegmentator._vendor.nnunetv2.imageio')
    if ret is None:
        raise RuntimeError("Unable to find reader writer class '%s'. Please make sure this class is located in the "
                           "fastsegmentator._vendor.nnunetv2.imageio module." % rw_class_name)
    else:
        return ret
